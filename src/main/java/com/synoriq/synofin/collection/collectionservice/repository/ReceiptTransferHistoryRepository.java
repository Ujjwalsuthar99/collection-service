...
public interface ReceiptTransferHistoryRepository extends JpaRepository<ReceiptTransferHistoryEntity, Long> {
    ...
    @Query(nativeQuery = true, value = "select\n" +
            ...
            "\trt.transfer_type, rt.amount as deposit_amount, ba2.bank_name , ba2.account_number, CAST(cal.geo_location_data as TEXT) as geo_location_data, CAST(rt.receipt_image as TEXT) as receipt_image\n" +
            "from\n" +
