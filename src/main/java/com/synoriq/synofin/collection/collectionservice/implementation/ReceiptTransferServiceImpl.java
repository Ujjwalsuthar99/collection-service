...
public class ReceiptTransferServiceImpl implements ReceiptTransferService {
    ...
    public BaseDTOResponse<Object> createReceiptTransferNew(Object object, MultipartFile transferProof, String token) throws Exception {
        ...
        try {
            ...
            UploadImageOnS3ResponseDTO transferProofUploaded = integrationConnectorService.uploadImageOnS3(token, transferProof, "receipt_transfer", geoLocationDTO.getLatitude(), geoLocationDTO.getLongitude(), false);
            String filePath = "";
